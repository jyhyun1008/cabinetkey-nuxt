<template>
    <div id="container">
        <div id="world-cont">
            ...
            <div id="world-text">
                <div id="title">{{ libraryJSON.title }}</div>
                <div id="url"></div>
        ...
        <div id="works-content">
            <div class="box-cont" v-for="(workContent, j) of libraryJSON.contents" style="margin-bottom: 20px;">
                ...
                <router-link style="flex-grow: 1; max-width: calc(100% - 60px);" :to="`/${route.params.username}/${route.params.world}/library/${route.params.libraryid}/${j+1}`">
